...
public class HttpConst {
    ...
    private static final String SERVER_HOST="47.101.161.236";
     ...
     * 请求地址：登录
     */
    public static String URL_LOGIN=BASE_URL+"/info";
    /**
     * 请求地址：获取表册
     */
    public static String URL_QUERY_BOOKFORMS=BASE_URL+"/info";
    /**
     * 请求地址：用水户详情
     */
    public static String URL_QUERY_USER_INFO=BASE_URL+"/info";
    /**
     * 请求地址：录入抄表信息
     */
    public static String URL_METER_READ=BASE_URL+"/info";
    /**
     * 请求地址：抄表记录互换
     */
    public static String URL_EXCHANGE_READ=BASE_URL+"/info";
}
